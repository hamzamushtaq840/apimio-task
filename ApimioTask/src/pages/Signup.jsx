...
const Signup = () => {
  ...
  return (
    <div className='bg-background flex flex-col justify-center items-center h-screen'>
      ...
      <p className='mb-8 font-medium text-center'>Or <span onClick={() => navigate('/')} className='cursor-pointer text-indigo-600 hover:text-indigo-500'>sign in to your existing account</span></p>
